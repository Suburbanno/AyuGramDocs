  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          'relative grow overflow-hidden rounded-full bg-neutral-700 data-[orientation=horizontal]:h-2 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-2',
        )}
      >
